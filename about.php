                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        <div class="hm_top_login">
                            <ul>
                                ...
                                <li><a href="index.php?log=logout"><button class="btn btn-danger" >LOGOUT</button></a></li>
                            </ul>
                        </div>
                    </div>
					...
					<div class="row">
						<div class="hm_test_inner">
							<div class="col-lg-4 col-md-4">
								<div class="hm_testi_box">
									<div class="hm_test_img">
										<img src="assets/images/customer1.png" alt="" class="img-responsive" />
									</div>
									<h2>Hilpton Broad</h2>
							...
							<div class="col-lg-4 col-md-4">
								<div class="hm_testi_box">
									<div class="hm_test_img">
										<img src="assets/images/customer2.png" alt="" class="img-responsive" />
									</div>
									<h2>Stive Philips</h2>
									<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of cla ssical Latin literature from 45 BC, making it over 2000 years old. </p>
								</div>
							...
							<div class="col-lg-4 col-md-4">
								<div class="hm_testi_box">
									<div class="hm_test_img">
										<img src="assets/images/customer3.png" alt="" class="img-responsive" />
									</div>
									<h2>James Carlo</h2>
									<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of cla ssical Latin literature from 45 BC, making it over 2000 years old. </p>
								</div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="hm_partners_slider">
                            <div class="owl-carousel owl-theme test_slider">
                                <div class="item"><img src="assets/images/partner1.png" alt=""></div>
                                <div class="item"><img src="assets/images/partner2.png" alt=""></div>
                                <div class="item"><img src="assets/images/partner3.png" alt=""></div>
                                <div class="item"><img src="assets/images/partner4.png" alt=""></div>
                                <div class="item"><img src="assets/images/partner5.png" alt=""></div>
                                <div class="item"><img src="assets/images/partner1.png" alt=""></div>
                                <div class="item"><img src="assets/images/partner2.png" alt=""></div>
                                <div class="item"><img src="assets/images/partner3.png" alt=""></div>
                                <div class="item"><img src="assets/images/partner4.png" alt=""></div>
